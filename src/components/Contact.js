    ...
    return (
        <div className="case">
            <div className="contactContent py-10">
                <div className="contactGrid py-20">
                    ...
                    <div className="contactInput">
                        ...
                        <label className="block">
                            ...
                            <textarea className="form-textarea mt-1 block w-full p-1 text-black border-2 border-black focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" rows="4" placeholder="Enter some long form content."></textarea>
                        </label>
                    </div>
                </div>
